...
// Cbddd-goa-ent-projectBoxConfig holds the schema definition for the Cbddd-goa-ent-projectBoxConfig entity.
type Cbddd-goa-ent-projectBoxConfig struct {
	ent.Schema
}

// Mixin of the Cbddd-goa-ent-projectBoxConfig.
func (Cbddd-goa-ent-projectBoxConfig) Mixin() []ent.Mixin {
	return []ent.Mixin{
		BaseMixin{},
	}
}

// Fields of the Cbddd-goa-ent-projectBoxConfig.
func (Cbddd-goa-ent-projectBoxConfig) Fields() []ent.Field {
	return []ent.Field{
...
// Edges of the Cbddd-goa-ent-projectBoxConfig.
func (Cbddd-goa-ent-projectBoxConfig) Edges() []ent.Edge {
	return nil
}
