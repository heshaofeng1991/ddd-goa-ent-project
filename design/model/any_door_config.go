...
var GetAnyDoorConfigList = Type("GetAnyDoorConfigList", func() {
	Field(1, "ddd-goa-ent-project_id", Int, "ddd-goa-ent-project_id 连击赏id")
	Field(2, "ddd-goa-ent-project_bun", Int, "ddd-goa-ent-project_bun 门槛(连击次数)")
...
var AddOrUpdateAnyDoorConfigReq = Type("AddOrUpdateAnyDoorConfigReq", func() {
	Field(1, "id", UInt, "id")
	Field(2, "ddd-goa-ent-project_id", Int, "ddd-goa-ent-project_id 连击赏id")
	Field(3, "ddd-goa-ent-project_bun", Int, "ddd-goa-ent-project_bun 门槛(连击次数)")
