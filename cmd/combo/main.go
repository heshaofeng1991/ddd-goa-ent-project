...
import (
	"ddd-goa-ent-project/domain/service"
	"ddd-goa-ent-project/ent"
	"ddd-goa-ent-project/gen/admin"
	"ddd-goa-ent-project/gen/healthy"
	"ddd-goa-ent-project/gen/web"
	"ddd-goa-ent-project/internal/dao"
	...
	_ "ddd-goa-ent-project/ent/runtime"
)
...
func main() {
	...
	)
	{
		...
		logger = log.New(os.Stderr, "[ddd-goa-ent-projectbox] ", log.Ltime)
