...
import (
	...
	adminsvr "ddd-goa-ent-project/gen/http/admin/server"
	healthysvr "ddd-goa-ent-project/gen/http/healthy/server"
	websvr "ddd-goa-ent-project/gen/http/web/server"
